<script type="text/javascript" src="<?= base_url(); ?>../js/MantenedorPago/MantenedorPago.js"></script>
<script>
   tabla();
</script>
      ...
      <div class="box-body">
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="form-group">
            <label for="Perfil" class="col-md-4 control-label">Valor Pago:</label>
            <div class="col-md-8">
              <select id="Perfil" style="height: 24px !important;width: 100% !important;">
                <option value="0">Seleccione</option>
                <?php foreach ($datosPerfil as $filas): ?>
                    <option value="<?= $filas['idPagoChofer'];?>"><?= $filas['montoC']; ?></option>                 
                <?php endforeach; ?> 
            </select>
            </div>
          </div>
